...
The mean number of times `r mean(apply(pred, 1, max))`, `r mean(sapply(lr.prob, max))`, `r mean(sapply(lr2.prob, max))`

TO DO:
4. Bonus: penalized logistic regression. 
5. Comments
### 6. BONUS!!!:D
...
The error on the test set equals `r mean(bestCharPred != Test[,1])`. 
